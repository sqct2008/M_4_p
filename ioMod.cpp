...
//  std::cin >> fontSize; 
//
//  if (TTF_OpenFont( fileName.c_str(), fontSize ) == NULL) {
...
void IOmod::writeText(const std::string& msg, const SDL_Color& tColor, int x, int y) const {
  SDL_Surface* surface = 
